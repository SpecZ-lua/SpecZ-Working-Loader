if game.PlaceId == 2753915549 or game.PlaceId == 4442272183 or game.PlaceId == 7449423635 then
  ...
  wait(10)
      ...
      do
          local ui = game.CoreGui:FindFirstChild("Toddy.exe")
          if ui then
              ui:Destroy()
          end
      end
      ...
      function library:AddWindow(text,keybind)
          ...
          function uitab:AddTab(text,image)
              local Image = image or  17527279121
              ...
              function main:AddDropdown(text,table,callback)
                  ...
                  DropImage.Image = "rbxassetid://17527279121"
  ...
  elseif placeId == 7449423635 then
      ...
      local sxhub = library:AddWindow("TODDY.EXE  | V1",Enum.KeyCode.RightControl)
  ...
  set:AddLabel("Setting")
      set:AddButton("Credit By _Styxznx7_",function()
  end)
      set:AddButton("Copy link Community toddy",function()
      setclipboard("https://discord.com/invite/blox-huntercommunity-t-1066471523965218979")
  end)
  ...
  wait(10)
      ...
      --
      local RenUi = library:AddWindow("FeliciaXxx | King Legacy",Enum.KeyCode.RightControl)
      --
